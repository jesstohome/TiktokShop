define(['jquery', 'bootstrap', 'backend', 'addtabs', 'adminlte', 'form', 'watermark'], function ($, undefined, Backend, undefined, AdminLTE, Form, Watermark) {
    var Controller = {
        index: function () {
            //双击重新加载页面
            ...
            //添加水印
            // Watermark.init({ watermark_txt: '1.0演示版本',watermark_width: 200 });
        ...
        login: function () {
            //添加水印
            // Watermark.init({ watermark_txt: '1.0演示版本',watermark_width: 200,watermark_color: '#000000',watermark_opacity:0 });
