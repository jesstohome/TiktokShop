<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"/www/wwwroot/demo.shop110.top/public/../application/admin/view/dashboard/index.html";i:1713668292;s:72:"/www/wwwroot/demo.shop110.top/application/admin/view/layout/default.html";i:1711598594;s:69:"/www/wwwroot/demo.shop110.top/application/admin/view/common/meta.html";i:1713930362;s:71:"/www/wwwroot/demo.shop110.top/application/admin/view/common/script.html";i:1713929490;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
                        ...
                        <div class="panel bg-blue-gradient no-border">
                            <div class="panel-body">
                                <div class="panel-title">
                                    ...
                                    <h5><?php echo __('Amount count'); ?></h5>
                                </div>
                                <div class="panel-content">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h1 class="no-margins"><?php echo number_format($totalSales,2); ?></h1>
                                            <div class="font-bold">
                                                <small><?php echo __('总销售额'); ?></small>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <h1 class="no-margins"><?php echo number_format($todaySales,2); ?></h1>
                                            <div class="font-bold">
                                                <small><?php echo __('今日销售额'); ?></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="panel bg-teal-gradient no-border">
                            <div class="panel-body">
                                <div class="ibox-title">
                                    <span class="label label-primary pull-right"><?php echo __('Real time'); ?></span>
                                    <h5><?php echo __('Order count'); ?></h5>
                                </div>
                                <div class="ibox-content">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h1 class="no-margins"><?php echo $totalOrderCount; ?></h1>
                                            <div class="font-bold">
                                                <small><?php echo __('总订单数'); ?></small>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <h1 class="no-margins"><?php echo $todayOrderCount; ?></h1>
                                            <div class="font-bold">
                                                <small><?php echo __('今日订单数'); ?></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xs-6 col-md-3">
                        <div class="panel bg-purple-gradient no-border">
                            <div class="panel-body">
                                <div class="ibox-title">
                                    <span class="label label-primary pull-right"><?php echo __('Real time'); ?></span>
                                    <h5><?php echo __('Merchant count'); ?></h5>
                                </div>
                                <div class="ibox-content">

                                    <div class="row">
                                        <div class="col-md-6">
                                            <h1 class="no-margins"><?php echo $totalMerchantCount; ?></h1>
                                            <div class="font-bold">
                                                <small><?php echo __('商户总数'); ?></small>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <h1 class="no-margins"><?php echo $todayMerchantCount; ?></h1>
                                            <div class="font-bold">
                                                <small><?php echo __('今日入驻商户数'); ?></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="panel bg-green-gradient no-border">
                            <div class="panel-body">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h1 class="no-margins"><?php echo $totalUserCount; ?></h1>
                                            <div class="font-bold">
                                                <small><?php echo __('用户总数'); ?></small>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <h1 class="no-margins"><?php echo $todayUserCount; ?></h1>
                                            <div class="font-bold">
                                                <small><?php echo __('今日新增用户数'); ?></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
