<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"/www/wwwroot/demo.shop110.top/public/../application/admin/view/auth/admin/edit.html";i:1713665634;s:72:"/www/wwwroot/demo.shop110.top/application/admin/view/layout/default.html";i:1711598594;s:69:"/www/wwwroot/demo.shop110.top/application/admin/view/common/meta.html";i:1713930362;s:71:"/www/wwwroot/demo.shop110.top/application/admin/view/common/script.html";i:1713929490;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<!--    <div class="form-group">-->
<!--        <label for="mobile" class="control-label col-xs-12 col-sm-2"><?php echo __('Code'); ?>:</label>-->
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input type="text" class="form-control" id="code" name="row[code]" value="<?php echo htmlentities($row['code'] ?? ''); ?>" data-rule="" placeholder="代理人账号选填"/>-->
<!--        </div>-->
<!--    </div>-->
    <div class="form-group">
