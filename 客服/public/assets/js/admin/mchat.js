                    ...
                    if (v.direction == 'to_service') {
                        ...
                        if(v.content.indexOf('<img')>= 0||v.content.indexOf('<a')>= 0||!isNaN(v.content)||v.content.indexOf('<video')>= 0){
                            ...
                            if(v.content_trans !=''){
                                ...
                                str += "<pre>" + v.content + "<span class='trans' data-cid='"+v.cid+"'>Translation</span></pre>";
                            }
                        }
                        str += "</div></div>";
                        str += "</li>";
                        ...
                        str += "<div class='outer-right'><div class='service'>";
                        str += "<pre>" + v.content + "&nbsp;&nbsp;<span onclick='revoke("+v.cid+",1);' class='revoke-text'>(revoke)</span></pre>";
                        str += "</div></div>";
                        str += "</li>";
...
var send = function() {
    ...
    if (msg == "") {
        ...
        str += "<div class='outer-right'><div class='service'>";
        str += "<pre>" + msg + "&nbsp;&nbsp;<span onclick=revoke('" + unstr + "',2); class='revoke-text'>(revoke)</span></pre>";
        str += "</div></div>";
        str += "</li>";
